...
figure~\ref{fig:parallel_R} for a field frequency of $30$~kHz.\\
...
condition for the RLC circuit is met. Figure~\ref{fig:RLC-IvI}
...
figure~\ref{fig:M-rel} and it can be seen that, as with the RL and
...
compared in figure~\ref{fig:PTE}. It can be seen that the shell
...
than using the simper RL circuitary. \\
