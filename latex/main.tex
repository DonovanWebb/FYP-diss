...
of field within the materials interior. If $\mu_r$ is small
...
shielded by superconducting material. MuMetal has
high relative permeabilities of up to $300,000+$ due to being a soft
ferromagnetic material. Ferromagnets have unusually high permeability
due to the exchange interaction between electrons favouring parallel
spins and, as explained by the Stoner Criterion, a high density of
states at the Fermi level. MuMetal is a nickel-iron alloy tuned to
maximise these two effects and by using a thin sheet, the easy axis of
magnetization lies in-plane further enforcing the field to be guided
within the sheets. Superconductors in their Meissner state ($B = 0$) will
...
high conductivity copper sheeting. From Lenz's law an oscillating magnetic field
perpendicular to a metal sheet will induce Eddy currents which will
oppose the changing field. At an appropriate frequency, which is
...
\caption{LHS: The constructed shells arranged in the power transfer
  ...
  (power transfer). A coil is supplied with an AC current with a
...
some constant. Suprisingly there is no explicit dependence of $V_2$ on
...
\begin{figure}
  ...
  \caption{
    ...
    efficiencies dependence on load resistance in a coupled non-resonant RL
...
\begin{figure}
  ...
  \caption{
    ...
    deflects the angular component of the fields.  The inset image
...
\begin{figure}
  \begin{center}
   \noindent\includegraphics[width=\linewidth]{images/compoundRLC-inset.pdf}
  \end{center}
  \caption{
    ...
    mutual inductance in the resonant parallel RLC circuit
    (equation~\ref{eqn:RLC-M}). Voltage across the transmitting coil
...
The effectiveness of these MuMetal and copper shells should
