...
DC: Non ideal behaviour \\
- more sheets better approximation - COMSOL \\
- no SC to block field - COMSOL \\
- further explanation on error source in placement \\

AC:
Coppers increase in efficiency \\
- COMSOL \\
- Suggested model with eddy currents.\\
